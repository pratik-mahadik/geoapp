...
const BulkModal: React.FC<ModalProps> = ({ isOpen, closeModal, exitModal, data }) => {
        ...
        if (selectedFile) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    try {
                        const apiResponse = await fetch('http://localhost:5000/task', {
                            method: 'POST', // Change to POST
                            body: JSON.stringify({ "project": 'Pune' }), // Replace with your POST data
                            headers: {
